	...
	<body>
		<div id="show-address" class="content scaffold-show" role="main">
			...
			<ol class="property-list address">
				...
				<g:if test="${addressInstance?.addressBookId}">
				<li class="fieldcontain">
					<span id="addressBookId-label" class="property-label"><g:message code="address.addressBookId.label" default="Address Book Id" /></span>
					
						<span class="property-value" aria-labelledby="addressBookId-label"><g:fieldValue bean="${addressInstance}" field="addressBookId"/></span>
				...
				<g:if test="${addressInstance?.attnName}">
				<li class="fieldcontain">
					<span id="attnName-label" class="property-label"><g:message code="address.attnName.label" default="Attn Name" /></span>
					
						<span class="property-value" aria-labelledby="attnName-label"><g:fieldValue bean="${addressInstance}" field="attnName"/></span>
				...
				<g:if test="${addressInstance?.directions}">
				<li class="fieldcontain">
					<span id="directions-label" class="property-label"><g:message code="address.directions.label" default="Directions" /></span>
					
						<span class="property-value" aria-labelledby="directions-label"><g:fieldValue bean="${addressInstance}" field="directions"/></span>
				...
				<g:if test="${addressInstance?.postalCodeExt}">
				<li class="fieldcontain">
					<span id="postalCodeExt-label" class="property-label"><g:message code="address.postalCodeExt.label" default="Postal Code Ext" /></span>
					
						<span class="property-value" aria-labelledby="postalCodeExt-label"><g:fieldValue bean="${addressInstance}" field="postalCodeExt"/></span>
