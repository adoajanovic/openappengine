...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- AD : APPLICATION DICTIONARY SCHEMA
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
CREATE TABLE AD_TABLE (
	T_TABLE_ID int(11) NOT NULL auto_increment,
	T_CLIENT_ID int(11) NOT NULL,
	T_ORGANIZATION_ID int(11) NOT NULL,
	T_IS_ACTIVE CHAR(1) DEFAULT 'Y'NOT NULL,
	T_NAME VARCHAR(60) NOT NULL,
	T_DESCRIPTION VARCHAR(255),
	T_TABLE_NAME VARCHAR(40) NOT NULL,
	T_CLASSNAME VARCHAR(60) NOT NULL,
	T_WINDOW_ID int(11) NOT NULL DEFAULT 0,
	T_IS_DELETEABLE CHAR(1) DEFAULT 'Y'NOT NULL,
	T_IS_HIGH_VOLUME CHAR(1) DEFAULT 'N'NOT NULL,
	T_IS_IMPORTABLE CHAR(1) DEFAULT 'N'NOT NULL,
	T_IS_CHANGE_LOG CHAR(1) DEFAULT 'N'NOT NULL,
...
CREATE TABLE AD_COLUMN (
	C_TABLE_ID int(11) NOT NULL auto_increment,
	C_CLIENT_ID int(11) NOT NULL,
	C_ORGANIZATION_ID int(11) NOT NULL,
	C_IS_ACTIVE CHAR(1) DEFAULT 'Y'NOT NULL,
	C_NAME VARCHAR(60) NOT NULL,
	C_DESCRIPTION VARCHAR(255),
	C_COLUMNNAME VARCHAR(40) NOT NULL,
	C_TABLE_ID int(11) NOT NULL,
	C_FIELDLENGTH NUMERIC(10 , 0) DEFAULT 0 NOT NULL,
	C_DEFAULTVALUE VARCHAR(2000),
	C_ISKEY CHAR(1) DEFAULT 'N'NOT NULL,
	C_ISMANDATORY CHAR(1) DEFAULT 'N'NOT NULL,
	C_ISUPDATEABLE CHAR(1) DEFAULT 'Y' CHAR NOT NULL,
	READONLYLOGIC VARCHAR(2000),
	ISIDENTIFIER BPCHAR(1) DEFAULT 'N'::BPCHAR NOT NULL,
	SEQNO NUMERIC(10 , 0),
	ISTRANSLATED BPCHAR(1) DEFAULT 'N'::BPCHAR NOT NULL,
	ISENCRYPTED BPCHAR(1) DEFAULT 'N'::BPCHAR NOT NULL,
	CALLOUT VARCHAR(60),
	VFORMAT VARCHAR(60),
	VALUEMIN VARCHAR(20),
	VALUEMAX VARCHAR(20),
	ISSELECTIONCOLUMN BPCHAR(1) DEFAULT 'N'::BPCHAR NOT NULL,
	AD_ELEMENT_ID VARCHAR(32),
	AD_PROCESS_ID VARCHAR(32),
	ISSESSIONATTR BPCHAR(1) DEFAULT 'N'::BPCHAR,
	ISSECONDARYKEY BPCHAR(1) DEFAULT 'N'::BPCHAR,
	ISDESENCRYPTABLE BPCHAR(1) DEFAULT 'N'::BPCHAR,
	AD_CALLOUT_ID VARCHAR(32),
	DEVELOPMENTSTATUS VARCHAR(60) DEFAULT 'RE'::CHARACTER VARYING,
	AD_MODULE_ID VARCHAR(32) DEFAULT '0'::CHARACTER VARYING NOT NULL,
	POSITION NUMERIC(131089 , 0),
	ISTRANSIENT BPCHAR(1) DEFAULT 'N'::BPCHAR,
	ISTRANSIENTCONDITION VARCHAR(2000),
	ISAUTOSAVE BPCHAR(1) DEFAULT 'Y'::BPCHAR NOT NULL,
	VALIDATEONNEW BPCHAR(1) DEFAULT 'Y'::BPCHAR NOT NULL,
	ISEXCLUDEAUDIT BPCHAR(1) DEFAULT 'N'::BPCHAR NOT NULL,
	IMAGESIZEVALUESACTION VARCHAR(60) DEFAULT 'N'::CHARACTER VARYING NOT NULL,
	IMAGEWIDTH NUMERIC(10 , 0),
	IMAGEHEIGHT NUMERIC(10 , 0)
	);
...
-- AD : NAVIGATION MENU
--
CREATE TABLE `AD_NAVIGATION_MENU` (
...
--
-- AD : NAVIGATION MENU ITEM
--
CREATE TABLE `AD_NAVIGATION_MENU_ITEM` (
...
CREATE TABLE `CL_ROLE` (
  ...
  `CR_AMOUNT_APPROVAL` NUMERIC(10,0),
...
CREATE TABLE `PLM_PRODUCT` (
  ...
  `PD_PRODUCT_VOLUME` decimal(10,2) NULL DEFAULT 0.0,
  `PD_PRODUCT_WEIGHT` decimal(10,2) NULL DEFAULT 0.0,
  `PD_PRODUCT_SHELF_HEIGHT` decimal(10,2) NULL DEFAULT 0.0,
  `PD_PRODUCT_SHELF_WIDTH` decimal(10,2) NULL DEFAULT 0.0,
  `PD_PRODUCT_SHELF_DEPTH` decimal(10,2) NULL DEFAULT 0.0,
  ...
  `PD_STANDARD_COST` decimal(10,2) NULL DEFAULT 0.0,
  `PD_QUANTITY_MAX` decimal(10,2) NULL DEFAULT 0.0,
  `PD_QUANTITY_MIN` decimal(10,2) NULL DEFAULT 0.0,
  `PD_QUANTITY_STD` decimal(10,2) NULL DEFAULT 0.0,
  `PD_QUANTITY_SAFETY_STOCK` decimal(10,2) NULL DEFAULT 0.0,
...
CREATE TABLE `FM_PAYMENT_TERMS` (
  ...
  `PYT_NET_DAYS` double NOT NULL,
  `PYT_FIXED_MONTH_DAY` double NULL,
  `PYT_FIXED_MONTH_OFFSET` double NULL,
  ...
  `PYT_FIXED_MONTH_DAY2` double NULL,
  `PYT_FIXED_MONTH_DAY3` double NULL,
  PRIMARY KEY(`PYT_PAYMENT_TERM_ID`)
);

---
--- FM : SERVICE CONTRACT
---
CREATE TABLE `FM_SERVICE_CONTRACT` (
  `SC_SERVICE_CONTRACT_ID` int(11) NOT NULL auto_increment,
  `SC_CONTRACT_NUMBER` varchar(60) NOT NULL,
  `SC_FROM_DATE` datetime NOT NULL,
  `SC_TO_DATE` datetime NOT NULL,
  `SC_CLIENT_ID` int(11) NOT NULL,
  `SC_ORGANIZATION_ID` int(11) NOT NULL,
  `SC_IS_ACTIVE` char(1) NOT NULL DEFAULT 'Y',
  `SC_NAME` varchar(60) NOT NULL,
  `SC_DESCRIPTION` varchar(255),
  `SC_DOCUMENT_NOTE` varchar(2000),
  `SC_REC_FREQUENCY` varchar(50) NOT NULL,
  PRIMARY KEY(`SC_SERVICE_CONTRACT_ID`)
);

---
--- FM : SERVICE CONTRACT LINES
---
CREATE TABLE `FM_SERVICE_CONTRACT_LINES` (
  `SC_CONTRACT_LINE_ID` int(11) NOT NULL auto_increment,
  `SC_CONTRACT_LINE_NUMBER` int(11) NOT NULL,
  `SC_FROM_DATE` datetime NOT NULL,
  `SC_TO_DATE` datetime NOT NULL,
  `SC_CLIENT_ID` int(11) NOT NULL,
  `SC_ORGANIZATION_ID` int(11) NOT NULL,
  ...
  `SC_PRICE_LIST_ID` int(11) NOT NULL,
  `SC_PRODUCT_QUANTITY` int(11) NOT NULL,
  `SC_PRODUCT_UOM_ID` int(11) NOT NULL,
  PRIMARY KEY(`SC_CONTRACT_LINE_ID`)
);

---
--- FM : INVOICE SCHEDULE
---
CREATE TABLE FM_INVOICE_SCHEDULE (
    SH_INVOICE_SCHEDULE_ID int(11) auto_increment NOT NULL,
    SH_CLIENT_ID int(11) NOT NULL,
    SH_ORGANIZATION_ID int(11) NOT NULL,
    SH_IS_ACTIVE char(1) NOT NULL DEFAULT 'Y',
    SH_NAME varchar (60) NOT NULL,
    SH_DESCRIPTION varchar (255),
    SH_IS_AMOUNT_LIMIT char(1) NOT NULL DEFAULT 'N',
    SH_INVOICE_FREQUENCY VARCHAR(50) NOT NULL DEFAULT 'M', -- TAB : Invoice_Frequency
    SH_INVOICE_GEN_WEEKDAY VARCHAR(50) NULL,
    SH_INVOICE_GEN_WEEKDAY_CUTOFF VARCHAR(50) NULL,
    SH_INVOICE_DAY int(11) NOT NULL DEFAULT 1,
    SH_INVOICE_SHIPMENT_CUTOFF_DAY int(11) NULL,
    SH_IS_DEFAULT char(1) NOT NULL DEFAULT 'N',
    PRIMARY KEY(SH_INVOICE_SCHEDULE_ID)
);

--
-- FM : DOCUMENT TYPE
--
CREATE TABLE FM_DOC_TYPE (
   `DT_DOC_TYPE_ID` int(11) NOT NULL auto_increment,
   `DT_PARTY_ID` varchar(50) NOT NULL,
   `DT_ORGANIZATION_ID` varchar(50) NOT NULL,
   `DT_IS_ACTIVE` char(1) NOT NULL DEFAULT 'T',
   `DT_NAME` VARCHAR(60) NOT NULL,  -- DOC TYPE NAME
   `DT_PRINT_NAME` VARCHAR(60) NOT NULL, -- DOC TYPE PRINT NAME
   `DT_DESCRIPTION` VARCHAR(255) NULL,
   `DT_IS_SO_TRX` char(1) NULL DEFAULT 'Y',
   `DT_DOC_BASE_TYPE` VARCHAR(255) NOT NULL, -- SOO (Sales Order)  
   `DT_DOC_SO_SUB_TYPE` VARCHAR(255) NULL, --WR (POS Order)
   `DT_DOC_TYPE_SHIPMENT_ID` int(11) NULL, 
   `DT_DOC_TYPE_INVOICE_ID` int(11) NULL,
   `DT_IS_DOC_NO_CONTROLLED` char(1) NULL DEFAULT 'Y',
   `DT_DOC_NO_SEQUENCE_ID` int(11) NULL,
   `DT_GL_CATEGORY_ID` int(11) NULL, -- MAKE NOT NULL LATER
   `DT_DOCUMENT_NOTE` VARCHAR(2000) NULL,
   `DT_IS_DEFAULT` CHAR(1) NULL DEFAULT 'N',
   `DT_DOCUMENT_COPIES` NUMERIC(10,0) NOT NULL DEFAULT 1,
   `DT_AD_TABLE_ID` INT(11) NULL,
   `DT_DOC_TYPE_REVERSED_ID` INT(11) NULL,
   `DT_IS_EXPENSE` CHAR(1) NULL DEFAULT 'N',
   `DT_IS_REVERSAL` CHAR(1) NULL DEFAULT 'N',
   PRIMARY KEY (`DT_DOC_TYPE_ID`)
);
...
CREATE TABLE `FM_ORDER` (
  ...
  `OR_DOCUMENT_TYPE_ID` int(11) NOT NULL, -- INTRODUCE A FM_DOC_TYPE TABLE FOR DOCUMENT CONTROL.
  `OR_DOCUMENT_TYPE_TARGET_ID` int(11) NULL, -- INTRODUCE A FM_DOC_TYPE TABLE FOR DOCUMENT CONTROL.
  ...
  `OR_DATE_ORDERED` datetime NOT NULL,
  `OR_DATE_PROMISED` datetime NULL,
  `OR_DATE_PRINTED` datetime NULL,
  `OR_DATE_ACCTG` datetime NULL,
...
-- FM : PAYMENT METHOD
--
CREATE TABLE `FM_PAYMENT_METHOD` (
  `PM_PAYMENT_METHOD_ID` int(11) NOT NULL auto_increment,
  `PM_CLIENT_ID` int(11) NOT NULL,
  `PM_ORGANIZATION_ID` int(11) NOT NULL,
  `PM_PAYMENT_METHOD_CODE` varchar(255) NOT NULL,
  `PM_PAYMENT_METHOD_VALUE` varchar(255) NOT NULL,
  `PM_PAYMENT_METHOD_DESCRIPTION` varchar(255) NOT NULL,
  PRIMARY KEY  (`PM_PAYMENT_METHOD_ID`)
);
...
CREATE TABLE `FM_ORDER_LINE` (
  ...
  `OL_PRICE_ACTUAL` double NOT NULL,
  `OL_PRICE_LIMIT` double NOT NULL,
  `OL_LINE_NET_AMOUNT` double NOT NULL,
  `OL_DISCOUNT` double,
  `OL_FREIGHT_AMOUNT` double NOT NULL,
  `OL_CHARGE_ID` int(11),
  `OL_CHARGE_AMOUNT` double,
...
-- PRICE LIST VERSION
--
CREATE TABLE `FM_PRICE_LIST_VERSION` (
...
CREATE TABLE `FM_PRODUCT_PRICE` (
  ...
  `PR_PRICE_LIST_VERSION_ID` int(11) NOT NULL DEFAULT 0,
  `PR_PRDUCT_ID` int(11) NOT NULL DEFAULT 0,
