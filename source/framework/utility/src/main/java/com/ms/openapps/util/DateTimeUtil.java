...
public class DateTimeUtil {
	...
	public static final String MAX_DATE_STRING_MMDDYYYY = "12/31/9999";
	
	public static final String MIN_DATE_STRING_MMDDYYYY  = "01/01/1900";
     ...
     */
    public static java.util.Date toFormattedDate(String dateTime,String format) {
        if (dateTime == null) {
            return null;
        }
