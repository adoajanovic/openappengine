...
public class ScreenElementDefinitionParserFactoryInitializer implements Callback<ScreenElementDefinitionParserFactory> {
	...
	private String packageToScan = "com.openappengine.gui.engine.context.factory.support.parser";
	...
	private void doRegisterActionHandler(ScreenElementDefinitionParserFactory factory, Class<? extends GuiElementDefinitionParser> clazz)
		...
		try {
			...
			Assert.notNull(parser.getParsedNodeName(), "Class extending [com.openappengine.gui.engine.context.factory.support.parser.GuiElementDefinitionParser] - The method : [getParsedNodeName()] cannot return a null or a blank.");
