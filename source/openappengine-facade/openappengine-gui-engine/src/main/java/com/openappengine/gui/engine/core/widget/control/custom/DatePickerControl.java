...
@Control(widgetControlName="datepicker")
public class DatePickerControl extends AbstractBaseWidgetControl {

	@Override
	public void encodeBegin(Element element, GuiEngineContext context,
			WidgetControlWriter writer) {
		writer.startElement("datepicker");
