...
CREATE TABLE `fm_order_header` (
  ...
  `OH_ORDER_TYPE_ID` varchar(255) DEFAULT NULL,
  ...
  `OH_STATUS_ID` varchar(20) DEFAULT NULL,
  ...
  `OH_GRAND_TOTAL` decimal(18,2) DEFAULT NULL,
  PRIMARY KEY (`OH_ORDER_ID`)
  --KEY `ORDER_HDR_TYPE` (`OH_ORDER_TYPE_ID`),
  --CONSTRAINT `ORDER_HDR_TYPE` FOREIGN KEY (`OH_ORDER_TYPE_ID`) REFERENCES `fm_order_type` (`OT_ORDER_TYPE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
...
CREATE TABLE `fm_order_type` (
  ...
  -- `OT_PARENT_TYPE_ID` int(11) DEFAULT NULL,
  `OT_HAS_TABLE` bit COLLATE latin1_general_cs DEFAULT NULL,
  `OT_DESCRIPTION` varchar(255) COLLATE latin1_general_cs DEFAULT NULL,
  PRIMARY KEY (`OT_ORDER_TYPE_ID`)
  -- KEY `ORDER_TYPE_PARENT` (`OT_PARENT_TYPE_ID`),
  -- CONSTRAINT `ORDER_TYPE_PARENT` FOREIGN KEY (`OT_PARENT_TYPE_ID`) REFERENCES `fm_order_type` (`OT_ORDER_TYPE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
DROP TABLE IF EXISTS `fm_order_item`;
CREATE TABLE `fm_order_item` (
  `OI_ORDER_ITEM_ID` int(11)  NOT NULL,
  `OI_ORDER_ID` int(11)  NOT NULL,
  `OI_ORDER_ITEM_SEQ_ID` varchar(20)  NOT NULL,
  `OI_EXTERNAL_ID` varchar(20)  DEFAULT NULL,
  `OI_ORDER_ITEM_TYPE_ID` varchar(255) DEFAULT NULL,
  ...
  `OI_IS_MODIFIED_PRICE` bit  DEFAULT NULL,
  `OI_ITEM_DESCRIPTION` varchar(255)  DEFAULT NULL,
  `OI_COMMENTS` varchar(255)  DEFAULT NULL,
  `OI_STATUS_ID` varchar(20)  DEFAULT NULL,
