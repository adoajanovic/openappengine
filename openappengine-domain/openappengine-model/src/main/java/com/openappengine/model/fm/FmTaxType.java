...
public class FmTaxType implements Serializable {
	...
	private List<FmTaxRateProduct> taxRateProducts;
	...
	public List<FmTaxRateProduct> getTaxRateProducts() {
		return taxRateProducts;
	}

	public void setTaxRateProducts(List<FmTaxRateProduct> taxRateProducts) {
		this.taxRateProducts = taxRateProducts;
	}
