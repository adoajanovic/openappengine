...
public class ProdProductPrice implements Serializable {
	...
	//bi-directional many-to-one association to ProdProductPriceType
    @ManyToOne
	@JoinColumn(name="PP_PRODUCT_PRICE_TYPE_ID", nullable=false)
	private ProdProductPriceType prodProductPriceType;
	...
	public ProdProductPriceType getProdProductPriceType() {
		return this.prodProductPriceType;
	}

	public void setProdProductPriceType(ProdProductPriceType prodProductPriceType) {
		this.prodProductPriceType = prodProductPriceType;
	}
