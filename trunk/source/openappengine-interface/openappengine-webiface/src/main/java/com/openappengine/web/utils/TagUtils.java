...
public class TagUtils {
	...
	private static EntityFacade entityFacade = EntityFacadeContext
			.getEntityFacade();
	...
	static {
		inputStream = TagUtils.class.getClassLoader().getResourceAsStream(
		...
		try {
			...
			throw new ComponentRenderException(
					"Cannot initialize the message bundle.");
		}
	...
	public static boolean isText(FieldDefinition field) {
	...
	public static boolean isAutoIncrement(FieldDefinition fieldDefinition) {
		...
		return fieldDefinition.isAutoincrement();
	}
}
